...
public class ReadingLevelActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        tvTitle.setText("📖 Reading - " + languageName);
    }
    ...
    private CardView createLevelCard(int level) {
        ...
        if (level <= currentLevel) {
            ...
            btnStart.setOnClickListener(v -> startReadingGame(level));
    ...
    private void startReadingGame(int level) {
